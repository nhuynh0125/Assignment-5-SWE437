 ...
 *         Data file of when retakes are given course.xml -- Data file with
...
public class quizsched {
	...
	private static final String dataLocation = "/Users/vanes/Desktop/quizretakes/"; /* CLI */
	...
	public static void main(String[] argv) /* CLI */
	{
		...
		try {
			...
			System.out.println("Can't find the data files for course ID " + courseID
					+ ". You can try again with a different course ID.");
			return;
		}
		...
		try { // Read the files and print the form
			...
			System.out.println("Can't read the data files for course ID " + courseID
					+ ". You can try again with a different courseID.");
			return;
		}
...
// Called from main to read student's choice and save to file
	 ...
	 * @param quizList
	 * @param retakesList
	 * @param course      Change the method from private to public, for easier
	 *                    access to write Junit test
	 */
// ===============================================================
